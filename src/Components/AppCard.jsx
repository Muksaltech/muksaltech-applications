...
export default function AppCard() {
    ...
    <div className="flex justify-end gap-6 text-[0.85rem] underline text-gray-500">
      <a href="/apps/identify-this/IdentifyThis" className="hover:text-gray-800 whitespace-nowrap">preview</a>
      <a href="/apps/identify-this/IdentifyThis" className="hover:text-gray-800 whitespace-nowrap">launch</a>
      <a href="/apps/identify-this/IdentifyThis" className="hover:text-gray-800 whitespace-nowrap">download code</a>
    </div>
    </div>
