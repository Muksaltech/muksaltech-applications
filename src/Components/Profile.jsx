        ...
        <article className="max-w-5xl mx-auto border border-gray-300 p-6 rounded-lg">
                ...
                <div className="flex flex-col md:flex-row gap-6">
                    ...
                    <main className="w-full md:w-2/3 p-4 rounded-lg shadow">
                        ...
                        Hello! I'm Mukaila — a passionate developer with over 20 years experience in building web and mobile applications, as well as engaging side projects. I have a strong appreciation for clean design and intuitive user experiences.
