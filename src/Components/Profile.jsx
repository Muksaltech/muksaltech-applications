    ...
    return <>
        <article className="max-w-5xl mx-auto border border-gray-300 p-6 rounded-lg">
                ...
                <div className="flex flex-col md:flex-row gap-6">
                    ...
                    {/* Sidebar / Profile */}
                    <aside className="w-full md:w-1/3 h-64  rounded-lg shadow-inner">
                        {/* Image, contact info, links, etc. */}
                    </aside>

                    {/* Main content */}
                    <main className="w-full md:w-2/3 p-4 rounded-lg shadow">
                        <p className="text-gray-300 leading-relaxed">
                        Hello! I'm Mukaila — a passionate developer with over 15 years experience in building web and mobile applications, as well as engaging side projects. I have a strong appreciation for clean design and intuitive user experiences.
